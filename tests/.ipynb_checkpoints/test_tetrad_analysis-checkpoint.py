...
def test_sort_and_filter_by_col():
    ...
    result = dataframe_functions.sort_and_filter_by_col(expected_df,expected_df['NAT'])
    
    assert result == test_tetrad_analysis.exp_sort_and_filter_by_col(expected_df,expected_df['NAT'])
